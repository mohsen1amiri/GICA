...
def plot_results(total_comparisons, runtimes, G_traces, lcb_traces, label="P-GIHA", epsilon=0.05, save_path="pgihA_metrics.png"):
...
if __name__ == "__main__":
    ...
    plot_compare(res_pgiha, res_mlingape, nameA="P-GIHA", nameB="m-LinGapE",
                 epsilon=ALG_PGIHA["epsilon"], save_path=outpath("compare_pgiha_mlingape"))

    plot_compare(res_pgiha, res_gifa, nameA="P-GIHA", nameB="LinGIFA",
    ...
    plot_compare(res_pgiha, res_xtreme, nameA="P-GIHA", nameB="eXtreme",
                 epsilon=ALG_PGIHA["epsilon"], save_path=outpath("compare_pgiha_xtreme"))

    plot_compare(res_pgiha, res_case, nameA="P-GIHA", nameB="CASE",
