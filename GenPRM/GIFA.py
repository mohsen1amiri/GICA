...
class LinGIFA:
    ...
    # def _C(self) -> float:
    #     """
    #     Heuristic threshold from Réda, Kaufmann, Delahaye-Duriez 2021,
    #     Section 5 (Experimental Study, p.8). This is what the paper uses
    #     in all reported experiments. The theoretical Eq.(2) bound is too
    #     conservative in practice (especially when sigma is small).
    #     """
    #     t = max(self.t, 1)  # avoid ln(0) at iteration 0
